...
const navList = reactive([
  ...
  { active: false, title: 'About', url: 'src/assets/imgs/004.webp' },
  { active: false, title: 'Services', url: 'src/assets/imgs/005.webp' },
  { active: false, title: 'Contact', url: 'src/assets/imgs/001.webp' },
])
